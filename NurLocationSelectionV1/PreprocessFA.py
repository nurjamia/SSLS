...
class preprocessFA:
    def __init__(self):
        print("preprocessing gowalla and brightkite to find the curve of ExactPlus using top 20% locations\n we normalize the final scores and user bin100,")
        ...
        self.beta = 0.5
        self.omega = 0.5
        self.k = 10  # top k items should be returned 2, 4, 6, 8, 10
        ...
        self.createFile(os.path.join(self.outputFolder, "Results", self.binId, "", "FAIntuition", "NormalizedScores_"+str(self.k)+".txt"), self.scoreNormalized)
        self.createFile(os.path.join(self.outputFolder, "Results", self.binId, "", "FAIntuition", "divideByTopScore_"+str(self.k)+".txt"), self.divideByTopScore)
