...
class MMDCalc:
    def __init__(self):
        print("Calculating MMD of FA greedy results.")
        #print(haversine((38.91, -94.76), (38.9, -94.77), miles=False))
        #print(haversine((38.9, -94.78), (38.89, -94.79), miles=False))
        print(haversine((38.85, -94.85), (38.85, -94.58), miles=False))
        print(haversine((38.85, -94.85), (39.11, -94.85), miles=False))
        #(38.85, -94.84)  to(39.11, -94.58)
        #quit()
        self.alpha = 0.5
        self.beta = 0.5
        self.omega = 0.5
        ...
        for k in kList:
            ...
            self.outputFolder = os.path.join(self.operatingFolder, "MMD_FA", str(self.k))
            self.resultFilesPath = os.path.join(self.operatingFolder, str(self.k))
            ...
            for files in listResultFiles:
                ...
                f = open(os.path.join(self.resultFilesPath, files), "r")
