...
class SociaCoverage:
    def __init__(self):
        print("calculating social coverage when Theta = 0 and Theta = 100 KM.. This is for SOS model, for our approaches , please run SocialCoverage.py")
        self.alpha = 0.5
        self.beta = 0.5
        self.omega = 0.5
        self.theta = 200
        self.thetaGS = 0.4
        self.ThetaForSC = 100 #100KM and Exact is default
        ...
        self.datasetName = "Yelp"
        self.insideFolders = "SOS\Results"
        ...
        for files in listResultFiles:
            ...
            totalwithinTheta = 0
            if files.replace(".txt", "").__contains__("_SocSpat_"):
            ...
            locsList = Util.convert_String_Into_List(self, self.resultFilesPath, files)
        ...
        print("Done: k and bins for SOS ", self.k, self.binId)
